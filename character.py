...
class Character:
    ...
    def __init__(self, loader):
        ...
        # stats
        self._pos = pygame.Vector2(pINIT_POS)
    ...
    def check_collision(self):
        ...
        if self._pos.x + self._rect.width >= mRIGHT:
            self._pos.x = mRIGHT - self._rect.width

        if self._pos.y + self._rect.height >= mBOTTOM:

            self._pos.y = mBOTTOM - self._rect.height
            self._vel.y = 0
